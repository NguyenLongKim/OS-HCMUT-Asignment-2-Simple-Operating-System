...
\fancyhead[L]{
 \begin{tabular}{rl}
    ...
    \put(0,-8){\includegraphics[width=8mm, height=8mm]{images/LogoBK.png}}
...
\fancyfoot[L]{\scriptsize \ttfamily Report: Assignment 2 - Operating System - Semester 192}
...
\input{subtex/title_page.tex}

% Table of contents
\newpage
\tableofcontents

\input{subtex/scheduler.tex}

\input{subtex/memory_management.tex}

\input{subtex/put_it_all_together.tex}
\end{document}